...
#ifndef SFAIT_SOFTPHONE_SWIFT_H
#define SFAIT_SOFTPHONE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SFAIT_Softphone",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15SFAIT_Softphone11AppDelegate")
...
SWIFT_CLASS("_TtC15SFAIT_Softphone17MainFlutterWindow")
